            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="{{url('medecin.generaliste.dashboard')}}">Tableau de bord du Médecin</a>
                  </li>
                  <li>
                    <a href="doctors-list.html">Liste des médecins</a>
                  </li>
                  {{-- <li>
                    <a href="doctors-cards.html">Doctors Cards</a>
                  </li> --}}
                  <li>
                    <a href="doctors-profile.html">Informations du Médecin</a>
                  </li>
                  <li>
                    <a href="{{route('admin.create')}}">Ajouter un médecin</a>
                  </li>
                  <li>
                    <a href="edit-doctors.html">Editer</a>
                  </li>
                </ul>
              </li>
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="patients-list.html">Répertoire des patients</a>
                  </li>
                  <li>
                    <a href="add-patient.html">Nouveau Patient</a>
                  </li>
                  <li>
                    <a href="edit-patient.html">Editer les détails</a>
                  </li>
                </ul>
              </li>
              <li class="treeview">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li>
                    <a href="{{route('departement.index')}}">Liste des departments</a>
                  </li>
                  <li>
                    <a href="{{route('departement.create')}}">Ajouter un department</a>
                  </li>
                  <li>
