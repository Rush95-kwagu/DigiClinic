                ...
                <div class="card">
                  ...
                  <div class="card-body">
                   ...
                   @endif
                        ...
                        <input type="text" class="form-control" id="code_depart" name="code_depart" required>
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                      ...
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="a5" name="telephone" placeholder="Entrez le téléphone du département" required>
                        </div>
                      </div>
                      <div class="col-xxl-3 col-lg-4 col-sm-6">
                        <div class="mb-3">
                          <label class="form-label" for="email">Email du département</label>
                          <input type="text" class="form-control" id="email" name="email" placeholder="Entrez l'email' du département" required>
                        </div>
                      </div>
