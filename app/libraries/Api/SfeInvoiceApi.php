...
use App\libraries\HeaderSelector;
use App\libraries\ObjectSerializer;
use GuzzleHttp\Psr7\Functions;
...
class SfeInvoiceApi
{
     ...
     *
     *
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\libraries\Model\StatusResponseDto
     */
     ...
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\libraries\Model\StatusResponseDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiInvoiceGetWithHttpInfo()
    {
        $returnType = '\App\libraries\Model\StatusResponseDto';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\libraries\Model\StatusResponseDto',
    ...
    protected function apiInvoiceGetRequest()
    {
        ...
        if (isset($_tempBody)) {
            ...
            if ($multipart) {
                ...
                // for HTTP post (form)
                $httpBody = \GuzzleHttp\Psr7\Functions::build_query($formParams);
            }
        }
        ...
        $query = $functions->build_query($queryParams);
        return new Request(
            'GET',
     ...
     *
     * @param  \App\libraries\Model\InvoiceRequestDataDto $body body (optional)
     *
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\libraries\Model\InvoiceResponseDto
     */
     ...
     *
     * @param  \App\libraries\Model\InvoiceRequestDataDto $body (optional)
     *
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\libraries\Model\InvoiceResponseDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiInvoicePostWithHttpInfo($body = null)
    {
        $returnType = '\App\libraries\Model\InvoiceResponseDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\libraries\Model\InvoiceResponseDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function apiInvoicePostRequest($body = null)
    {
        ...
        $query = \GuzzleHttp\Psr7\Functions::build_query($queryParams);
        return new Request(
            'POST',
            $this->config->getHost() . $resourcePath . ($query ? "?{$query}" : ''),
            $headers,
     ...
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\libraries\Model\SecurityElementsDto
     */
     ...
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\libraries\Model\SecurityElementsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiInvoiceUidCancelPutWithHttpInfo($uid)
    {
        $returnType = '\App\libraries\Model\SecurityElementsDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\libraries\Model\SecurityElementsDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \App\libraries\Model\InvoiceDetailsDto
     */
     ...
     * @throws \App\libraries\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \App\libraries\Model\InvoiceDetailsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiInvoiceUidGetWithHttpInfo($uid)
    {
        $returnType = '\App\libraries\Model\InvoiceDetailsDto';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\App\libraries\Model\InvoiceDetailsDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
